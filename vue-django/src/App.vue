      ...
      >
        <v-list>
          <v-list-item class="px-2">
            <v-list-item-avatar>
              <v-img src="./assets/Logo_reino_da_mata.jpg"></v-img>
            </v-list-item-avatar>
          </v-list-item>
          ...
          <v-list-item link>
            <v-list-item-content>
              <v-list-item-title class="title">
                Centro Reino da Mata
              </v-list-item-title>
              <v-list-item-subtitle>Templo Umbandista</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
        </v-list>
...
//import Pixabay from "./components/pyxabay/Pixabay";
...
export default {
  ...
  data(){
    return {
      ...
      {ruta:"/pixa",nombre:"Galería Imagenes",icono:"mdi-folder"},
      ],
      mostrarMenu: false,
      miniVariant: true,
    }
